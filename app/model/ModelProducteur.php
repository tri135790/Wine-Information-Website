...
public function __toString() {
 ...
 public static function view() {
  printf("<tr><td>%d</td><td>%s</td><td>%d</td><td>%s</td></tr>", $this->getId(), $this->getNom(), $this->getPrenom(), $this->getRegion());
 }
 ...
 public static function getListeProducteur(){
     ...
     return ModelProducteur::getMany($query);
 }
 
 public static function getProducteurById($id) {
     try {
   $database = Model::getInstance();
 ...
 public static function getListeRegionDistinct() {
 ...
 public static function delete($id) {
  ...
  try {
   ...
   // Soustrayez l'id de chaque producteur par 1
   

   // supprimer d'un  tuple;
